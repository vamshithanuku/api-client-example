package api.client.example.participation.invoker;
...
import api.client.example.participation.invoker.auth.Authentication;
import api.client.example.participation.invoker.auth.HttpBasicAuth;
import api.client.example.participation.invoker.auth.ApiKeyAuth;
import api.client.example.participation.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-05-27T20:21:07.926653-04:00[America/New_York]")@Component("api.client.example.participation.invoker.ApiClient")
